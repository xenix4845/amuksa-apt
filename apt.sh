...
EOF
    ...
    if (( $(echo "$os_version < 24" | bc -l) )); then
        ...
        cat > /etc/apt/sources.list << EOF
deb https://mirror.amuksa.com/ubuntu/ $codename main restricted universe multiverse
deb https://mirror.amuksa.com/ubuntu/ $codename-updates main restricted universe multiverse
deb https://mirror.amuksa.com/ubuntu/ $codename-backports main restricted universe multiverse
deb https://mirror.amuksa.com/ubuntu/ $codename-security main restricted universe multiverse
EOF
...
Types: deb
URIs: https://mirror.amuksa.com/ubuntu/
